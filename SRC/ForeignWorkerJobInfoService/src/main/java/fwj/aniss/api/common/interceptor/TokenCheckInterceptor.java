package fwj.aniss.api.common.interceptor;
...
//import fwj.aniss.api.common.bean.member.MemberBean;
import fwj.aniss.api.common.constants.Constants;
import fwj.aniss.api.common.utils.JwtTokenHelper;
...
public class TokenCheckInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
        ...
        if (authToken != null) {
            authToken = authToken.trim().substring(6, authToken.length());

            hasToken = StringUtils.isNotEmpty(authToken) ? true : false;
        ...
        if (hasToken) {
            ...
            try {
                ...
                // memberBean.setMemberNo(Long.parseLong(issuer));
                // memberBean.setMemberPhone(subject);
